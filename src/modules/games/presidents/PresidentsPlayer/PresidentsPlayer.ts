import { prop as Property , Ref, DocumentType, ReturnModelType, modelOptions as ModelOptions, plugin as Plugin } from '@typegoose/typegoose';
...
export default class PresidentsPlayer extends Player  {
  ...
  public async addDrinkRequestReceived(this: DocumentType<typeof PresidentsPlayer>, request: ReturnModelType<typeof DrinkRequest>) {
